	...
	namespace Functions_BasicTypes
	{
		...
		JSBool init(JSContext* cx, JSObject* scope)
		{
			JSFunctionSpec functions[] = {
				...
				// RETURN VALUE, NO PARAMETER
				JS_FS("bool_param0",                 bool_param0_wrap,                  1, 0),
				JS_FS("char_param0",                 char_param0_wrap,                  1, 0),
				JS_FS("signed_char_param0",          signed_char_param0_wrap,           1, 0),
				JS_FS("unsigned_char_param0",        unsigned_char_param0_wrap,         1, 0),
				JS_FS("short_param0",                short_param0_wrap,                 1, 0),
				JS_FS("unsigned_short_param0",       unsigned_short_param0_wrap,        1, 0),
				JS_FS("int_param0",                  int_param0_wrap,                   1, 0),
				JS_FS("unsigned_int_param0",         unsigned_int_param0_wrap,          1, 0),
				JS_FS("long_param0",                 long_param0_wrap,                  1, 0),
				JS_FS("unsigned_long_param0",        unsigned_long_param0_wrap,         1, 0),
				JS_FS("float_param0",                float_param0_wrap,                 1, 0),
				JS_FS("double_param0",               double_param0_wrap,                1, 0),
				JS_FS("long double_param0",          long_double_param0_wrap,           1, 0),
				JS_FS("wchar_t_param0",              wchar_t_param0_wrap,               1, 0),
