...
\newcommand{\myRefFigure}[1]{\textit{\hyperref[#1]{Figure ~\ref*{#1}}}}
\newcommand{\myRefFigureName}[1]{\textit{\hyperref[#1]{Figure ~\ref*{#1}: ~\nameref{#1}}}}

\newcommand{\myRefListing}[1]{\textit{\hyperref[#1]{Listing ~\ref*{#1}}}}
...
\newcommand{\mySCString}[1]{\textcolor{gray}{``\texttt{#1}''}}
