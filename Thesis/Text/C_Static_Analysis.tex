...
An example function that a script may provide is ''process\_type(t)'', which is called by \myProperName{Dehydra} whenever a new type was found in the compiling code.
