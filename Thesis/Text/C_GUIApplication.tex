...
Thus, diagnosing potential error sources before generating glue code is an essential task of any language binding generator.
...
The existence of templates that are referenced by the code generator using their identifier (e.g. ''CPP\_Spidermonkey/function'') needs to be verified.\\
