...
When selecting a row in the export tree, the result \mySCName{Object Explorer} (5) will be filled with the result of the code generation for that specific object and its children. This is handy for debugging. The result can be inspected and the generated glue code can be viewed. If the code generation fails, the result  \mySCName{Object Explorer} will show the input that was used for generation.
