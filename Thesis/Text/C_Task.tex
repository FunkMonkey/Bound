...
The necessary information about the symbols and types declared in the provided C++ header files will be retrieved and reprocessed using a self-written static analysis tool that uses the \myProperName{Clang} C/C++ compiler internally.

Other long term goals, outside of the time interval of this thesis, include the support for other scripting languages, a language module for exporting \myProperName{SWIG} interfaces, enhanced usability and the support of input languages different from C/C++.