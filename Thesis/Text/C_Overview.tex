...
The exported information will be used in a GUI application based on the \myProperName{Mozilla Framework}, as described in \myRefChapter{chap:GUIApplication}. This chapter will introduce the basic architecture of the application and explain how the symbol information is used to create language binding code for \myProperName{JavaScript}.

\myRefChapter{chap:Summary} and \myRefChapter{chap:FutureDevelopment} form the \textbf{conclusion}.

\section{Formatting}

Proper names of companies and products --- e.g. \myProperName{Mozilla}, \myProperName{Firefox} or \linebreak\myProperName{JavaScript}) --- are written in capital letters.
