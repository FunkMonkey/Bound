...
The result should be the other way around, because the time delay for \mySCString{Hello} is 10 and thus after \mySCString{World}. Because of the queue that does not know about execution order, the callback that prints \mySCString{Hello} is called first.
