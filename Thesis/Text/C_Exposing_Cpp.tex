...
The \myProperName{C++} class hierarchy does not necessarily need to be replicated on the \myProperName{JavaScript} side. \todo{ref} shows that base class members can also just be defined on the subclass wrapper.
