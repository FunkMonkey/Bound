...
The \myProperName{JSAPI} user has to decide upon which side is responsible for freeing \linebreak the memory --- meaning which party holds the \textbf{ownership}. Depending on the application, this is not necessarily the party that allocated the memory.
